        ...
        return (
            <Fragment>
                <Navbar className="navbar fixed-top navbar-expand-md navbar-light navbar-bg-flexinets">
                    ...
                    {isLoggedIn() && <NavbarToggler onClick={() => this.setState({ isOpen: !this.state.isOpen })} />}
                    {isLoggedIn() &&
                ...
                <Account isOpen={this.state.accountModalOpen} onDismiss={() => this.setState({ accountModalOpen: false })} />
